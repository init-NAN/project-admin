      ...
      <el-form :model="searchDetailForm" ref="searchDetailForm" label-width="auto">
        <el-row class="buttonHead">
          <el-col :span="12" :xs="24" :sm="24" :lg="12" :xl="12">
            <div class="left">
              <el-button  type="primary" class="el-icon-plus btn-addmore" @click="addApplication">   装修申请</el-button>
              <el-button  type="primary" class="el-icon-edit btn-addmore" :disabled="isDisEdit" @click="editSelection">编辑</el-button>
              <el-button  type="primary" class="el-icon-delete btn-addmore" :disabled="isDisDelete" @click="deleteSelections">删除</el-button>
              <el-button  type="primary" class="el-icon-edit btn-addmore" :disabled="isDisabled">收费</el-button>
              <el-button  type="primary" class="el-icon-check btn-addmore" :disabled="isDisConfirm" @click="confirmSelections">完成验收</el-button>
